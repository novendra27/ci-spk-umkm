...
<section class="content">
    <div class="container-fluid">
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <button type="button" class="btn btn-success mb-3" data-toggle="modal" data-target="#tambahModal">Tambah Data Kriteria</button>
            ...
            <form>
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="kodeKriteria" placeholder="Masukkan Kode Kriteria" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="namaBobot">Nama Bobot</label>
                        <input type="text" class="form-control" id="namaBobot" placeholder="Masukkan Nama Bobot" required>
                    </div>
                    <div class="form-group">
                        <label for="nilaiBobot">Nilai Bobot</label>
                        <input type="number" class="form-control" id="nilaiBobot" placeholder="Masukkan Nilai Bobot" required>
                    </div>
                </div>
